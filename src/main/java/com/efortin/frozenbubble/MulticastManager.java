...
public class MulticastManager {
   ...
   * @throws java.net.UnknownHostException the address is invalid.
   * @throws java.io.IOException socket creation failed.
   */
   ...
   * @throws java.net.UnknownHostException the host name is invalid.
   * @throws java.io.IOException socket creation failed.
   */
